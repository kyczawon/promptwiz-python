...
class DefaultApi:
    ...
    @validate_arguments
    def evaluate(self, request : Request, **kwargs) -> ApiResponse:  # noqa: E501
        """evaluate  # noqa: E501

        ### Sample Curl request  ``` curl -H 'Content-Type: application/json' \\ -d '{ \"apiKey\":\"d91a37db-a16b-4108-8485-f88496b30886\", \"querySet\": [{\"promptId\":\"5\",\"variables\":{\"PERSON\":\"Einstein\",\"QUESTION TO ASK\":\"What is 1+1?\"}}, {\"promptId\":\"5\",\"variables\":{\"PERSON\":\"Borris Johnson\",\"QUESTION TO ASK\":\"What is 1+1?\"}, \"resultsSize\":2}]}' \\ -N -X POST \\ http://www.promptwiz.co.uk/api/v0.1/evaluate/ ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.evaluate(request, async_req=True)
        >>> result = thread.get()
        ...
        return self.evaluate_with_http_info(request, **kwargs)  # noqa: E501

    @validate_arguments
    def evaluate_with_http_info(self, request : Request, **kwargs) -> ApiResponse:  # noqa: E501
        """evaluate  # noqa: E501
        ...
        >>> thread = api.evaluate_with_http_info(request, async_req=True)
        >>> result = thread.get()
