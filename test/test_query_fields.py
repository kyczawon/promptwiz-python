...
from openapi_client.models.query_fields import QueryFields  # noqa: E501

class TestQueryFields(unittest.TestCase):
    """QueryFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFields:
        """Test QueryFields
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFields`
        """
        model = QueryFields()  # noqa: E501
        if include_optional:
            return QueryFields(
                prompt_id = 56,
                variables = {
